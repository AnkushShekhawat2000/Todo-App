...
const sendEmailVerificationMail = ({token, email}) => {
    ...
    const transporter = nodemailer.createTransport({
        ...
        service: 'gmail',
        auth: {
            user: "ashekhawat8191@gmail.com",
            pass: "suwt mhhm gbhp vfup"
        }
    })
    ...
    transporter.sendMail(mailOptions, (error, info)=> {
        if(error){
            ...
            console.log(`Email has been successfully sent to : ${email}` + info.response);
        }
    })
...
module.exports = { userDataValidation, isEmailValidator, generateToken, sendEmailVerificationMail };
